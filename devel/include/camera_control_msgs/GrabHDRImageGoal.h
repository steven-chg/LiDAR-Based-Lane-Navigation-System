...
struct GrabHDRImageGoal_
{
  ...
  _exposure_given_type exposure_given;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _exposure_times_type;
  ...
  _brightness_given_type brightness_given;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _brightness_values_type;
  ...
  _gain_given_type gain_given;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _gain_values_type;
  ...
  _gamma_given_type gamma_given;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _gamma_values_type;
