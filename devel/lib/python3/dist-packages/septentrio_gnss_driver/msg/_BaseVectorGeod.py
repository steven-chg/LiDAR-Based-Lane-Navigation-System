...
"""autogenerated by genpy from septentrio_gnss_driver/BaseVectorGeod.msg. Do not edit."""
import codecs
import sys
...
class BaseVectorGeod(genpy.Message):
  _md5sum = "1349428be748ae82d66f928c5daf71dd"
  _type = "septentrio_gnss_driver/BaseVectorGeod"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# BaseVectorGeod block 
# Block_Number 4028
...
uint32  signal_info"""
  ...
  _slot_types = ['std_msgs/Header','septentrio_gnss_driver/BlockHeader','uint8','uint8','septentrio_gnss_driver/VectorInfoGeod[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,block_header,n,sb_length,vector_info_geod
    ...
    """
    if args or kwds:
      super(BaseVectorGeod, self).__init__(*args, **kwds)
      ...
      if self.sb_length is None:
        self.sb_length = 0
      if self.vector_info_geod is None:
        self.vector_info_geod = []
    else:
      self.header = std_msgs.msg.Header()
      self.block_header = septentrio_gnss_driver.msg.BlockHeader()
      self.n = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.vector_info_geod)
      buff.write(_struct_I.pack(length))
      for val1 in self.vector_info_geod:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = septentrio_gnss_driver.msg.VectorInfoGeod()
        _x = val1
        start = end
        end += 52
        ...
        self.vector_info_geod.append(val1)
      return self
