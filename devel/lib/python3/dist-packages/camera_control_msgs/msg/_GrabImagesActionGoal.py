...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.goal.exposure_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.goal.exposure_times)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.exposure_times))
      _x = self.goal.gain_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.goal.gain_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.gain_values))
      _x = self.goal.gamma_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.goal.gamma_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.gamma_values))
      _x = self.goal.brightness_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.goal.brightness_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.brightness_values))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.goal.exposure_times = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.goal.gain_values = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.goal.gamma_values = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.goal.brightness_values = s.unpack(str[start:end])
      _x = self
      start = end
      end += 2
