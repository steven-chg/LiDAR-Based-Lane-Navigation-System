...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.exposure_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.exposure_times)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.exposure_times))
      _x = self.gain_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.gain_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.gain_values))
      _x = self.gamma_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.gamma_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.gamma_values))
      _x = self.brightness_given
      buff.write(_get_struct_B().pack(_x))
      length = len(self.brightness_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.brightness_values))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.exposure_times = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.gain_values = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.gamma_values = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.brightness_values = s.unpack(str[start:end])
      _x = self
      start = end
      end += 2
